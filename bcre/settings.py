...
#__file__ is current file settings.py, parent.parent is two level up,->bcre->erb6
...
#SECRET_KEY = 'django-insecure-#nfvygglh13qh^e(u@$m@(c$2gz6$khe=a#+3cd^@&9w3(q4wk'
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize', # Humanize is used to make numbers more readable, e.g., 1,000 instead of 1000
    "debug_toolbar",
